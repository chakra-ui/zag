...
To load the next page as the user scrolls, pair this with
[infinite-scroll](/utilities/infinite-scroll). Async list owns the cursor and
items. Infinite scroll owns the sentinel.
