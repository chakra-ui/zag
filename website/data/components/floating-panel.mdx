...
Each part includes a component-scoped data attribute that you can use to target
specific elements.
...
[data-floating-panel-stage-trigger] {
  /* Add styles for state buttons in the header */
}

[data-floating-panel-resize-trigger] {
  /* Add styles for resize handles */
}

/* North and south resize handles */
[data-floating-panel-resize-trigger][data-placement="n"],
[data-floating-panel-resize-trigger][data-placement="s"] {
  /* Add styles for north and south resize handles */
}

/* East and west resize handles */
[data-floating-panel-resize-trigger][data-placement="e"],
[data-floating-panel-resize-trigger][data-placement="w"] {
  /* Add styles for east and west resize handles */
}

/* Corner resize handles */
[data-floating-panel-resize-trigger][data-placement="ne"],
[data-floating-panel-resize-trigger][data-placement="nw"],
[data-floating-panel-resize-trigger][data-placement="se"],
[data-floating-panel-resize-trigger][data-placement="sw"] {
...
```css
[data-floating-panel-content][data-dragging] {
...
[data-floating-panel-content][data-topmost] {
  /* Add styles for topmost state */
}

/* When the panel is behind another panel */
[data-floating-panel-content][data-behind] {
