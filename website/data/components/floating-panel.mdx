...
The KendoReact Window generates a variety of events that you can handle. This
allows you to tailor the behavior of the Window to your specific requirements.
