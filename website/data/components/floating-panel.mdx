...
[data-scope="floating-panel"][data-part="resize-trigger"][data-placement="n"],
[data-scope="floating-panel"][data-part="resize-trigger"][data-placement="s"] {
  /* Add styles for north and south resize handles */
}

/* East and west resize handles */
[data-scope="floating-panel"][data-part="resize-trigger"][data-placement="e"],
[data-scope="floating-panel"][data-part="resize-trigger"][data-placement="w"] {
  /* Add styles for east and west resize handles */
}

/* Corner resize handles */
[data-scope="floating-panel"][data-part="resize-trigger"][data-placement="ne"],
[data-scope="floating-panel"][data-part="resize-trigger"][data-placement="nw"],
[data-scope="floating-panel"][data-part="resize-trigger"][data-placement="se"],
[data-scope="floating-panel"][data-part="resize-trigger"][data-placement="sw"] {
