...
When using checkbox selection (`onCheckedChange`), item and branch control
elements expose `data-checked` and `data-indeterminate` attributes for styling.

```css
[data-part="item"][data-checked] {
  /* styles for fully checked items */
}

[data-part="item"][data-indeterminate] {
  /* styles for partially checked items (some children selected) */
}

[data-part="branch-control"][data-checked] {
  /* styles for fully checked branches */
}

[data-part="branch-control"][data-indeterminate] {
