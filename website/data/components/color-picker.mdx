  ...
  data={[
    {
      ...
      description: (
        <span>
          ...
          <br />
          When focus is on a trigger of a swatch, selects the color (and closes
          the color picker)
          <br />
    ...
    },
    {
      ...
      description: (
        <span>
          ...
          <br />
          When focus is on the channel sliders, decreases the value of the
          channel
        </span>
      ),
    },
    {
      ...
      description: (
        <span>
          ...
          <br />
          When focus is on the channel sliders, increases the value of the
          channel
        </span>
      ),
    },
    {
      ...
      description: (
        <span>
          When focus is on the color area, increases the saturation value of the
          color
          <br />
          When focus is on the channel sliders, increases the value of the
          channel
    ...
    },
    {
      ...
      description: (
        <span>
          When focus is on the color area, decreases the saturation value of the
          color
          <br />
          When focus is on the channel sliders, decreases the value of the
          channel
