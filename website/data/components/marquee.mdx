...
```css
[data-marquee-edge][data-side="start"] {
  width: 100px;
  background: linear-gradient(to right, white, transparent);
}

[data-marquee-edge][data-side="end"] {
  width: 100px;
...
[data-marquee-content][data-side="start"],
[data-marquee-content][data-side="end"] {
  animation-name: marqueeX;
}

[data-marquee-content][data-side="top"],
[data-marquee-content][data-side="bottom"] {
  animation-name: marqueeY;
}

[data-marquee-content][data-reverse] {
...
```css
[data-marquee-root][data-orientation="horizontal"] {
  /* styles for horizontal marquee */
}

[data-marquee-root][data-orientation="vertical"] {
...
```css
[data-marquee-content][data-clone] {
