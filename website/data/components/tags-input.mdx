...
By default, tags are add/remove only. To allow inline editing — double-clicking
a tag or focusing it and pressing `Enter` — set `editable: true`.
...
```css
[data-tags-input-root][data-focus] {
  /* styles for root focus state */
}

[data-tags-input-label][data-focus] {
  /* styles for label focus state */
}

[data-tags-input-input]:focus {
...
```css
[data-tags-input-root][data-invalid] {
  /* styles for invalid state for root */
}

[data-tags-input-label][data-invalid] {
  /*  styles for invalid state for label */
}

[data-tags-input-input][data-invalid] {
...
```css
[data-tags-input-root][data-disabled] {
  /* styles for disabled state for root */
}

[data-tags-input-label][data-disabled] {
  /* styles for disabled state for label */
}

[data-tags-input-input][data-disabled] {
  /* styles for disabled state for input */
}

[data-tags-input-control][data-disabled] {
...
```css
[data-tags-input-item-preview][data-disabled] {
...
```css
[data-tags-input-item-preview][data-highlighted] {
...
```css
[data-tags-input-root][data-readonly] {
  /* styles for readonly for root */
}

[data-tags-input-control][data-readonly] {
  /* styles for readonly for control */
}

[data-tags-input-input][data-readonly] {
  /* styles for readonly for input  */
}

[data-tags-input-label][data-readonly] {
