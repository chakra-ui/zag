  ...
  data={[
    {
      ...
      description: (
        <span>
          When focus is on trigger, opens the select and focuses the first
          selected item.
          <br />
    ...
    },
    {
      ...
      description: (
        <span>
          When focus is on trigger, selects the item whose label starts with the
          typed character.
          <br />
          When focus is on the listbox, moves focus to the next item with a
          label that starts with the typed character.
        </span>
      ),
    },
  ]}
