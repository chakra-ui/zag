...
```css
[data-select-trigger][data-state="open|closed"] {
  /* styles for open or closed state */
}

[data-select-content][data-state="open|closed"] {
  /* styles for open or closed state */
}
...
```css
[data-select-item][data-state="checked|unchecked"] {
...
```css
[data-select-label][data-invalid] {
...
[data-select-label][data-disabled] {
...
```css
[data-select-trigger][data-placeholder-shown] {
