...
```css
[data-accordion-item][data-state="open|closed"] {
  /* styles for the item is open or closed state */
}

[data-accordion-item-trigger][data-state="open|closed"] {
  /* styles for the item is open or closed state */
}

[data-accordion-item-content][data-state="open|closed"] {
  /* styles for the item is open or closed state */
}
```
...
```css
[data-accordion-item][data-focus] {
  /* styles for the item's focus state */
}

[data-accordion-item-trigger]:focus {
  /* styles for the trigger's focus state */
}

[data-accordion-item-content][data-focus] {
