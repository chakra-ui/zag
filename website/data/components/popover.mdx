...
<KeyboardTable
  data={[
    ...
    },
    {
      ...
      description: (
        <span>
          ...
          <br />
          <strong>Note:</strong> If there are no focusable elements, focus is
          moved to the next focusable element after the trigger.
        </span>
      ),
    },
    {
    ...
    },
    {
      keys: ["Esc"],
      description: (
        <span>Closes the popover and moves focus to the trigger.</span>
      ),
    },
  ]}
/>
