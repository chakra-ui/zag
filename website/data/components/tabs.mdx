...
```css
[data-tabs-trigger][data-orientation="(horizontal|vertical)"] {
  /* Styles for horizontal/vertical tabs */
}

[data-tabs-root][data-orientation="(horizontal|vertical)"] {
  /* Styles for horizontal/vertical root */
}

[data-tabs-indicator][data-orientation="(horizontal|vertical)"] {
  /* Styles for horizontal/vertical tab-indicator */
}

[data-tabs-list][data-orientation="(horizontal|vertical)"] {
