...
```css
[data-dialog-content][data-state="open|closed"] {
  /* styles for the open state */
}

[data-dialog-trigger][data-state="open|closed"] {
  /* styles for the open state */
}
```
