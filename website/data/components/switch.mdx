...
```css
[data-switch-root][data-focus] {
  /* styles for root focus state */
}

[data-switch-control][data-focus] {
  /* styles for control focus state */
}

[data-switch-label][data-focus] {
...
[data-switch-control][data-disabled] {
  /* styles for control disabled state */
}

[data-switch-label][data-disabled] {
...
```css
[data-switch-root][data-invalid] {
  /* styles for root invalid state */
}

[data-switch-control][data-invalid] {
  /* styles for control invalid state */
}

[data-switch-label][data-invalid] {
