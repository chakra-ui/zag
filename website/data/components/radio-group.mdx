...
item, control, and text parts.

```css
[data-radio-group-item][data-state="checked|unchecked"] {
  /* styles for radio checked or unchecked state */
}

[data-radio-group-item-control][data-state="checked|unchecked"] {
  /* styles for radio checked or unchecked state */
}

[data-radio-group-item-text][data-state="checked|unchecked"] {
  /* styles for radio checked or unchecked state */
}
```
...
[data-radio-group-item-control][data-focus] {
...
[data-radio-group-item-control][data-disabled] {
...
When the radio is invalid, the `data-invalid` attribute is added to the item,
control and text parts.
...
[data-radio-group-item-control][data-invalid] {
