...
```css
[data-combobox-control][data-state="open|closed"] {
  /* styles for open or closed control state */
}

[data-combobox-input][data-state="open|closed"] {
  /* styles for open or closed input state */
}

[data-combobox-trigger][data-state="open|closed"] {
  /* styles for open or closed trigger state */
}

[data-combobox-content][data-state="open|closed"] {
...
```css
[data-combobox-control][data-focus] {
  /* styles for control focus state */
}

[data-combobox-label][data-focus] {
...
```css
[data-combobox-label][data-disabled] {
  /* styles for label disabled state */
}

[data-combobox-control][data-disabled] {
...
```css
[data-combobox-root][data-invalid] {
  /* styles for root invalid state */
}

[data-combobox-label][data-invalid] {
  /* styles for label invalid state */
}

[data-combobox-control][data-invalid] {
...
```css
[data-combobox-item][data-state="checked|unchecked"] {
