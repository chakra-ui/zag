...
```css
[data-angle-slider-root][data-disabled] {
  /* styles for root disabled state */
}

[data-angle-slider-label][data-disabled] {
  /* styles for label disabled state */
}

[data-angle-slider-control][data-disabled] {
  /* styles for control disabled state */
}

[data-angle-slider-thumb][data-disabled] {
  /* styles for thumb disabled state */
}

[data-angle-slider-marker][data-disabled] {
  /* styles for marker disabled state */
}
```
...
control, value text, label, thumb, and marker parts.

```css
[data-angle-slider-root][data-invalid] {
  /* styles for root invalid state */
}

[data-angle-slider-label][data-invalid] {
  /* styles for label invalid state */
}

[data-angle-slider-control][data-invalid] {
  /* styles for control invalid state */
}

[data-angle-slider-value-text][data-invalid] {
  /* styles for output invalid state */
}

[data-angle-slider-thumb][data-invalid] {
  /* styles for thumb invalid state */
}

[data-angle-slider-marker][data-invalid] {
...
```css
[data-angle-slider-marker][data-state="(at|under|over)-value"] {
