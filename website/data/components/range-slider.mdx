  ...
  data={[
    {
      keys: ["ArrowRight"],
      description: (
        <span>Increments the focused thumb based on defined step</span>
      ),
    },
    {
      keys: ["ArrowLeft"],
      description: (
        <span>Decrements the focused thumb based on defined step</span>
      ),
    },
    {
      keys: ["ArrowUp"],
    ...
    },
    {
      keys: ["PageUp"],
      description: (
        <span>Increases the focused thumb value by a larger step</span>
      ),
    },
    {
      keys: ["PageDown"],
      description: (
        <span>Decreases the focused thumb value by a larger step</span>
      ),
    },
    {
      keys: ["Shift + ArrowUp"],
