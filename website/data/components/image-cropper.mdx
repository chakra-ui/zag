...
```css
[data-image-cropper-root] {
  /* styles for the root part */
}

[data-image-cropper-viewport] {
  /* styles for the viewport part */
}

[data-image-cropper-image] {
  /* styles for the image part */
}

[data-image-cropper-selection] {
  /* styles for the selection part */
}

[data-image-cropper-handle] {
...
```css
[data-image-cropper-selection][data-shape="circle"] {
  /* styles for circular selection */
}

[data-image-cropper-selection][data-shape="rectangle"] {
...
```css
[data-image-cropper-root][data-dragging] {
  /* styles when dragging the selection */
}

[data-image-cropper-root][data-fixed] {
