...
[data-password-input-visibility-trigger] {
  /* styles for the visibility trigger part */
}

[data-password-input-indicator] {
...
```css
[data-password-input-input][data-state="visible"] {
  /* styles for the visible state (for input) */
}

[data-password-input-visibility-trigger][data-state="visible"] {
...
```css
[data-password-input-input][data-disabled] {
...
```css
[data-password-input-input][data-invalid] {
...
```css
[data-password-input-input][data-readonly] {
