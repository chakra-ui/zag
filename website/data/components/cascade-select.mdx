...
```css
[data-cascade-select-trigger][data-state="open|closed"] {
  /* styles for open or closed state */
}

[data-cascade-select-content][data-state="open|closed"] {
  /* styles for open or closed state */
}
```
...
```css
[data-cascade-select-item][data-state="checked|unchecked"] {
...
```css
[data-cascade-select-item][data-highlighted] {
...
```css
[data-cascade-select-item][data-has-children] {
...
```css
[data-cascade-select-label][data-invalid] {
  /* styles for invalid state */
}

[data-cascade-select-trigger][data-invalid] {
  /* styles for invalid state */
}
```
...
```css
[data-cascade-select-trigger][data-disabled] {
  /* styles for disabled state */
}

[data-cascade-select-label][data-disabled] {
  /* styles for disabled label state */
}

[data-cascade-select-item][data-disabled] {
...
```css
[data-cascade-select-trigger][data-placeholder-shown] {
