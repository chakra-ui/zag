...
```css
[data-checkbox-root][data-state="checked|unchecked|indeterminate"] {
  /* styles for when checkbox is checked */
}

[data-checkbox-control][data-state="checked|unchecked|indeterminate"] {
  /* styles for when checkbox is checked */
}

[data-checkbox-label][data-state="checked|unchecked|indeterminate"] {
  /* styles for when checkbox is checked */
}
```
...
```css
[data-checkbox-root][data-focus] {
  /* styles for root focus state */
}

[data-checkbox-control][data-focus] {
  /* styles for control focus state */
}

[data-checkbox-label][data-focus] {
...
[data-checkbox-control][data-disabled] {
  /* styles for control disabled state */
}

[data-checkbox-label][data-disabled] {
...
```css
[data-checkbox-root][data-invalid] {
  /* styles for root invalid state */
}

[data-checkbox-control][data-invalid] {
  /* styles for control invalid state */
}

[data-checkbox-label][data-invalid] {
