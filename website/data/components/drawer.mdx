...
When the drawer is open and a different trigger is activated, it switches
...
```css
[data-drawer-content][data-state="open|closed"] {
  /* styles for the content in different states */
}

[data-drawer-trigger][data-state="open|closed"] {
...
```css
[data-drawer-content][data-swiping] {
...
[data-drawer-content][data-expanded] {
  /* when at the fully expanded snap point */
}

[data-drawer-content][data-swipe-direction] {
  /* physical swipe direction: "up" | "down" | "left" | "right" */
}

[data-drawer-backdrop][data-swiping] {
  /* backdrop during swipe or drag */
}

[data-drawer-swipe-area][data-disabled] {
  /* when swipe area is disabled */
}

[data-drawer-swipe-area][data-swipe-direction] {
...
[data-drawer-content][data-state="closed"] {
