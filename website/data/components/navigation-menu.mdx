...
<CodeSnippet id="navigation-menu/listening-for-events.mdx" />
...
<CodeSnippet id="navigation-menu/vertical-orientation.mdx" />
...
<CodeSnippet id="navigation-menu/rtl-support.mdx" />
