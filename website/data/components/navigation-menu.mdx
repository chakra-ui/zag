...
```css
[data-navigation-menu-content][data-state="open|closed"] {
  /* Styles for open or closed content */
}

[data-navigation-menu-trigger][data-state="open|closed"] {
  /* Styles for open or closed trigger */
}

[data-navigation-menu-viewport][data-state="open|closed"] {
...
```css
[data-navigation-menu-item][data-state="open"] {
...
```css
[data-navigation-menu-item][data-disabled] {
...
```css
[data-navigation-menu-root][data-orientation="horizontal|vertical"] {
  /* Orientation-specific styles */
}

[data-navigation-menu-list][data-orientation="horizontal"] {
  display: flex;
  flex-direction: row;
}

[data-navigation-menu-list][data-orientation="vertical"] {
  display: flex;
...
```css
[data-navigation-menu-link][data-current] {
...
[data-navigation-menu-indicator][data-orientation="horizontal"] {
  left: 0;
  translate: var(--trigger-x) 0;
  width: var(--trigger-width);
}

[data-navigation-menu-indicator][data-orientation="vertical"] {
  top: 0;
