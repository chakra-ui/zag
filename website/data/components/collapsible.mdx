...
```css
[data-collapsible-root][data-state="open|closed"] {
  /* styles for the collapsible is open or closed state */
}

[data-collapsible-trigger][data-state="open|closed"] {
  /* styles for the collapsible is open or closed state */
}

[data-collapsible-content][data-state="open|closed"] {
  /* styles for the collapsible is open or closed state */
}
```
...
```css
[data-collapsible-root][data-focus] {
  /* styles for the item's focus state */
}

[data-collapsible-trigger][data-focus] {
  /* styles for the content's focus state */
}

[data-collapsible-content][data-focus] {
  /* styles for the content's focus state */
}
```
