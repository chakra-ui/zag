...
The scroll area requires the following styles on the viewport element to hide
...
```css
[data-scroll-area-scrollbar][data-scrolling] {
  /* styles when actively scrolling */
}

[data-scroll-area-thumb][data-scrolling] {
...
```css
[data-scroll-area-root][data-hover] {
...
```css
[data-scroll-area-scrollbar][data-hidden] {
