...
title: Tour
description:
  Headless product tour and onboarding component for React, Vue, Solid, and
  Svelte. Step-by-step overlays with tooltip, dialog, and floating steps.
package: "@zag-js/tour"
---
...
- `dismiss`: End the tour. Use this when the user is unlikely to want to see the
  tour again.
