...
```css
[data-slider-root][data-focus] {
  /* styles for root focus state */
}

[data-slider-thumb]:focus {
  /* styles for thumb focus state */
}

[data-slider-control][data-focus] {
  /* styles for control focus state */
}

[data-slider-track][data-focus] {
  /* styles for track focus state */
}

[data-slider-range][data-focus] {
...
```css
[data-slider-root][data-disabled] {
  /* styles for root disabled state */
}

[data-slider-label][data-disabled] {
  /* styles for label disabled state */
}

[data-slider-control][data-disabled] {
  /* styles for control disabled state */
}

[data-slider-value-text][data-disabled] {
...
[data-slider-range][data-disabled] {
  /* styles for thumb disabled state */
}
```
...
```css
[data-slider-root][data-invalid] {
  /* styles for root invalid state */
}

[data-slider-label][data-invalid] {
  /* styles for label invalid state */
}

[data-slider-control][data-invalid] {
  /* styles for control invalid state */
}

[data-slider-value-text][data-invalid] {
  /* styles for output invalid state */
}

[data-slider-thumb][data-invalid] {
  /* styles for thumb invalid state */
}

[data-slider-range][data-invalid] {
...
```css
[data-slider-root][data-orientation="(horizontal|vertical)"] {
  /* styles for horizontal or vertical  */
}

[data-slider-thumb][data-orientation="(horizontal|vertical)"] {
  /* styles for horizontal or vertical  */
}

[data-slider-track][data-orientation="(horizontal|vertical)"] {
  /* styles for horizontal or vertical  */
}
```
...
```css
[data-slider-marker][data-state="(at|under|over)-value"] {
