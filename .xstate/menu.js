...
const fetchMachine = createMachine(
  ...
  },
  {
    ...
    guards: {
      ...
      "!isMenuFocused && !isTriggerActiveItem && !suspendPointer && !isActiveItem": (ctx) =>
        ctx["!isMenuFocused && !isTriggerActiveItem && !suspendPointer && !isActiveItem"],
      ...
      "!isTriggerActiveItem && !isActiveItemFocusable && closeOnSelect": (ctx) =>
