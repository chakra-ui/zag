...
const fetchMachine = createMachine(
  ...
  },
  {
    ...
    guards: {
      ...
      "(!isAtMax || allowOverflow) && !isInputValueEmpty": (ctx) =>
        ctx["(!isAtMax || allowOverflow) && !isInputValueEmpty"],
      ...
      "hasTags && isInputCaretAtStart && !isLastTagFocused": (ctx) =>
        ctx["hasTags && isInputCaretAtStart && !isLastTagFocused"],
