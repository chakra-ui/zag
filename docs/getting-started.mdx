...
UI Machines can be used within most JSX frameworks like Vue, React and Solid. The easiest way to use UI machines in your
components is by leveraging the `useMachine` hook we provide for each framework.

To get UI machines running, you'd need to first install the actual machine(s) and then your desired framework package.
...
UI machine is framework agnostic and supports React, Vue and Solid. Follow the steps below to use in your preferred framework.
