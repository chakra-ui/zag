...
export const WheelPickerAnatomy = createComponent((props) => {
  ...
  return (
    <svg width={1456} height={812} viewBox="0 0 1456 812" fill="none" xmlns="http://www.w3.org/2000/svg" {...rest}>
      ...
      <rect x={450} y={194} width={556} height={452} rx={8} fill={palette[3]} />
      <rect x={450} y={194} width={556} height={452} rx={8} fill={palette[3]} stroke={palette[9]} />
      <rect x={458} y={202} width={540} height={436} rx={4} stroke={palette[9]} strokeDasharray="6 6" />
      <rect x={466} y={319} width={524} height={48} rx={4} stroke={palette[9]} strokeDasharray="6 6" />
      ...
      <rect x={458} y={390} width={540} height={48} rx={4} stroke={palette[9]} strokeDasharray="6 6" />
      <text
        x={728}
        y={423}
        fill={palette[0]}
      ...
      <g stroke={palette[1]} strokeWidth={3}>
        ...
        <path d="M410 220H224" />
        <path d="M450 290H224" />
        <path d="M998 238H1232" />
        <path d="M990 343H1232" />
        <path d="M1006 414H1232" />
        <path d="M998 438V500H1232" />
        <path d="M728 438V584H1232" />
      </g>
