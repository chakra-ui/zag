...
describe("solid: watchEffect basics", () => {
...
describe("solid: effect declaration edges", () => {
...
describe("solid: dep value semantics", () => {
...
describe("solid: scheduling and races", () => {
...
describe("solid: restart coalescing", () => {
...
describe("solid: controlled open prop (the dialog shape)", () => {
...
describe("solid: teardown reason", () => {
