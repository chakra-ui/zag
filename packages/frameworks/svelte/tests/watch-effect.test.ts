...
describe("svelte: watchEffect basics", () => {
...
describe("svelte: effect declaration edges", () => {
...
describe("svelte: dep value semantics", () => {
...
describe("svelte: scheduling and races", () => {
...
describe("svelte: restart coalescing", () => {
...
describe("svelte: controlled open prop (the dialog shape)", () => {
...
describe("svelte: teardown reason", () => {
