...
- [`156940f`](https://github.com/chakra-ui/zag/commit/156940fa22b7bf82d499d71c46509623cac196b6) Thanks
  [@segunadebayo](https://github.com/segunadebayo)! - Fix controlled `paths` sync by keeping in-progress drawing in
  `onDraw.currentPath` instead of appending it to `paths`.
