...
- [#3308](https://github.com/chakra-ui/zag/pull/3308)
  ...
  [@github-actions](https://github.com/apps/github-actions)! - Fixed issue where cut (`Ctrl/Meta+X`) was blocked on
  non-React frameworks. Deletion `beforeinput` events are no longer treated as invalid typed values.
- Updated dependencies []:
...
- [#3061](https://github.com/chakra-ui/zag/pull/3061)
  [`1918417`](https://github.com/chakra-ui/zag/commit/19184170c0e94a3e852276a237636617cff2bd32) Thanks
