...
export const dom = defineDomHelpers({
  ...
  getContentEl: (ctx: Ctx) => dom.getById(ctx, dom.getContentId(ctx)) as HTMLElement,
  getTriggerEl: (ctx: Ctx) => dom.getById(ctx, dom.getTriggerId(ctx)) as HTMLElement,
  getUnderlayEl: (ctx: Ctx) => dom.getById(ctx, dom.getUnderlayId(ctx)) as HTMLElement,
  getTitleEl: (ctx: Ctx) => dom.getById(ctx, dom.getTitleId(ctx)) as HTMLElement,
  getDescriptionEl: (ctx: Ctx) => dom.getById(ctx, dom.getDescriptionId(ctx)) as HTMLElement,
})
