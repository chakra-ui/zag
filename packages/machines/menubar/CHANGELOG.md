...
- [#3308](https://github.com/chakra-ui/zag/pull/3308)
  ...
  [@github-actions](https://github.com/apps/github-actions)! - Fixed issue where a trigger disabled with the native
  `disabled` attribute stayed in the arrow key and typeahead rotation:
