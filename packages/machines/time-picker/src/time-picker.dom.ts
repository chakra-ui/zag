...
export const dom = createScope({
  ...
  getHourCellEls: (ctx: Ctx) => queryAll(dom.getContentEl(ctx), `[data-part=cell][data-unit=hour]`),
  getMinuteCellEls: (ctx: Ctx) => queryAll(dom.getContentEl(ctx), `[data-part=cell][data-unit=minute]`),
  getSecondCellEls: (ctx: Ctx) => queryAll(dom.getContentEl(ctx), `[data-part=cell][data-unit=second]`),
  getPeriodCellEls: (ctx: Ctx) => queryAll(dom.getContentEl(ctx), `[data-part=cell][data-unit=period]`),
