...
- [`9ccb894`](https://github.com/chakra-ui/zag/commit/9ccb89426e9d48483bd95739800322c4865ecacc) Thanks
  [@segunadebayo](https://github.com/segunadebayo)! - - Fixed issue where the scroll lock could apply to the wrong
  element (`<body>`) on layouts where `<html>` is the actual scroll container, silently doing nothing.
