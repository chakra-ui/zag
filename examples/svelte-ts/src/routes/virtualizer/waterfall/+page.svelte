<script lang="ts">
  ...
  const store = useWaterfallVirtualizer({
    count: ITEM_COUNT,
    columnCount: 3,
    columnGap: 12,
    rowGap: 12,
...
<main style="padding: 20px; width: 100%; max-width: 960px">
  ...
  <p style="color: #64748b">
    Masonry layout with {ITEM_COUNT.toLocaleString()} variable-height cards across {store.waterfallState.columnCount} columns.
  </p>
