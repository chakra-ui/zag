        ...
        <div style={{ width: "100%" }}>
          <div className="tabs">
            ...
            <div ref={ref} {...machineState.value.tablistProps}>
              <button {...machineState.value.getTabProps({ value: "nils" })}>Nils Frahm</button>
              <button {...machineState.value.getTabProps({ value: "agnes" })}>Agnes Obel</button>
              <button {...machineState.value.getTabProps({ value: "complex" })}>Joke</button>
            </div>
            <div {...machineState.value.getTabPanelProps({ value: "nils" })}>
              <p>
            ...
            <div {...machineState.value.getTabPanelProps({ value: "agnes" })}>
              <p>
            ...
            <div {...machineState.value.getTabPanelProps({ value: "complex" })}>
