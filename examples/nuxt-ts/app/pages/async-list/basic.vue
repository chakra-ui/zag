...
const service = useMachine(asyncList.machine as asyncList.Machine<Character>, {
  autoReload: true,
  initialFilter: "",
        ...
        items.length > 0
          ? items.slice().sort((a, b) => {
              if (sorting.column != null) {
                let cmp = a[sorting.column as keyof Character] < b[sorting.column as keyof Character] ? -1 : 1
