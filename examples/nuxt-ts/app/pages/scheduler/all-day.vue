  ...
  <main class="scheduler">
    <div v-bind="api.getRootProps()">
      ...
      <div class="scheduler-time-grid-wrapper">
        ...
        <div v-bind="api.getAllDayRowProps()" class="scheduler-all-day-row">
          <div class="scheduler-all-day-label">All day</div>
          <div v-for="d in api.visibleDays" :key="d.toString()" class="scheduler-all-day-cell">
            <div
              v-for="event in api.getEventsForDay(d).filter((e) => e.allDay)"
              :key="event.id"
