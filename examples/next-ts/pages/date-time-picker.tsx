...
export default function Page() {
  const controls = useControls(dateTimePickerControls)
  ...
  const api = dateTimePicker.connect(state, send, normalizeProps)

  return (
    <>
      <main className="date-time-picker">
        <div>
        ...
        <div {...api.positionerProps}>
          <div {...api.contentProps}>
            ...
            <div hidden={api.view !== "day"} style={{ marginBottom: "20px" }}>
            ...
            <div style={{ display: "flex", gap: "40px", marginBottom: "20px" }}>
              ...
              <div hidden={api.view !== "year"} style={{ width: "100%", marginBottom: "20px" }}>
                <div {...api.getViewControlProps({ view: "year" })}>
