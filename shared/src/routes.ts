...
export const componentRoutes: ComponentRoute[] = [
  {
    ...
    examples: [
      ...
      { slug: "constraints", title: "Drop Constraints" },
      { slug: "external-drop", title: "External Drop" },
      { slug: "editable-events", title: "Editable Events" },
      { slug: "timezone", title: "Time Zone" },
      { slug: "i18n", title: "i18n / RTL" },
  ...
  },
  {
    ...
    label: "Meter",
    examples: [
      { slug: "basic", title: "Storage (low is better)" },
      { slug: "battery", title: "Battery (high is better)" },
    ],
  },
  {
    slug: "field",
  ...
  },
  {
    ...
    examples: [
      ...
      { slug: "root-drop", title: "Root Drop" },
      { slug: "copy-move", title: "Copy vs Move" },
